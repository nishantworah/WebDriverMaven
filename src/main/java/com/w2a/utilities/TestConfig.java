...
public class TestConfig{
	...
	public static String server="smtp.yahoo.com";
	public static String from = "nishantworah@yahoo.com";
	public static String password = "Sugiyuvi@6928";
	public static String[] to ={"nishantworah@gmail.com"};
